...
A collection of lightweight Python games and interactive simulations developed during long academic lectures. From terminal-based logic puzzles to visual experiments like the Boids flocking algorithm, these scripts focus on clean logic, efficient state management, and satisfying intellectual curiosity-all while keeping the codebase concise (typically under 200 lines).
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/yourusername/boredom_solvers.git](https://github.com/yourusername/boredom_solvers.git)
